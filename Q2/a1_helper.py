"""
Helper functions used in Assignment 1
"""
import torch
import torchvision
import ail721
...
def get_CIFAR10_data(validation_ratio=0.02, flatten=False):
    ...
    """
    X_train, y_train, X_test, y_test = ail721.data.cifar10()
    ...
    plt.imshow(ail721.tensor_to_image(img))
    plt.axis('off')
    plt.show()
